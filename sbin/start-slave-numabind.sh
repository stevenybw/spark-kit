...
function start_instance {
  WORKER_NUM=$1
  shift
  NUMA_NODE_NUM=$(( ${WORKER_NUM} % ${SPARK_NUMA_NODES} ))
  ...
  echo "Starting worker ${WORKER_NUM} at NUMA NODE ${NUMA_NODE_NUM}"
  numactl --cpunodebind=${NUMA_NODE_NUM} "${SPARK_HOME}/sbin"/spark-daemon.sh start $CLASS $WORKER_NUM \
